...
def Search_Pro(request):
    ...
    if search_query:
        posts = Compentence.objects.filter(Q(name__icontains = search_query)|
        Q(category__titre__icontains=search_query)|
        Q(profil__user__username__icontains=search_query))
